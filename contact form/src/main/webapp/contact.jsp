...
<body>
	<form action="send" method="post">
		...
		<label>Name</label><br> <input type="text" name="name" id="name"
			required="required"><br> <label>Mobile No</label><br>
		<input type="number" name="mobno" id="mobno" required="required"><br>
		...
		<label>email</label><br> <input type="email" name="email"
			id="email" required="required"><br> <br> <label>Age</label><br>
