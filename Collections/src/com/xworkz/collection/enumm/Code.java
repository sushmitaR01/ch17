package com.xworkz.collection.enumm;

public enum Code {
	
	
	AFG(004), ALB(8), DZA(012), ASM(016), AND(020), AGO(024), AIA(660), ATG(28), ARG(032), ARM(051), ABW(533), AUS(780),
	AUT(040), AZE(031), BHS(044), BHR(48), BGD(050), BRB(052), BLR(112), BEL(056), BLX(58), BLZ(678), BEN(204), BMU(060),
